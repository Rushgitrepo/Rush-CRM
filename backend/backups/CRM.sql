...
CREATE TABLE deals (
  ...
  workspace_id uuid REFERENCES workgroups(id),
  source_info text,
...
CREATE TABLE drive_permissions (
  id uuid NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  drive_id uuid REFERENCES connected_drives(id),
  org_id uuid REFERENCES organizations(id),
  user_id uuid REFERENCES users(id),
...
CREATE TABLE lead_workspace_access (
  ...
  workspace_id uuid NOT NULL REFERENCES workgroups(id),
...
CREATE TABLE marketing_ab_test_results (
  id uuid NOT NULL DEFAULT uuid_generate_v4() PRIMARY KEY,
  test_id uuid REFERENCES marketing_ab_tests(id),
  variant_id uuid REFERENCES marketing_ab_test_variants(id),
  contact_id uuid REFERENCES contacts(id),
...
CREATE TABLE marketing_campaigns (
  ...
  design jsonb,
  stats jsonb DEFAULT '{"sent": 0,
  "opened": 0,
  "bounced": 0,
  "clicked": 0,
  "delivered": 0,
  "unsubscribed": 0}'::jsonb,
  org_id uuid REFERENCES organizations(id),
  segment_id uuid,
  sent_count integer DEFAULT 0,
  opened_count integer DEFAULT 0,
...
CREATE TABLE marketing_webhook_logs (
  id uuid NOT NULL DEFAULT uuid_generate_v4() PRIMARY KEY,
  webhook_id uuid REFERENCES marketing_webhooks(id),
  event_type character varying(50) NOT NULL,
...
CREATE TABLE workgroup_activities (
  id uuid NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  workgroup_id uuid NOT NULL REFERENCES workgroups(id),
  user_id uuid REFERENCES users(id),
...
CREATE TABLE workgroup_files (
  id uuid NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  workgroup_id uuid NOT NULL REFERENCES workgroups(id),
  channel_id uuid REFERENCES workgroup_channels(id),
  post_id uuid REFERENCES workgroup_posts(id),
  name character varying(255) NOT NULL,
...
CREATE TABLE workgroup_meeting_participants (
  id uuid NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  meeting_id uuid NOT NULL REFERENCES workgroup_meetings(id),
  user_id uuid NOT NULL REFERENCES users(id),
...
CREATE TABLE workgroup_members (
  ...
  notification_settings jsonb DEFAULT '{"meetings": true,
  "mentions": true,
  "messages": true}'::jsonb,
...
CREATE TABLE workgroup_posts (
  ...
  channel_id uuid REFERENCES workgroup_channels(id),
  user_id uuid NOT NULL REFERENCES users(id),
  parent_id uuid REFERENCES workgroup_posts(id),
